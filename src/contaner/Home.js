    ...
    <div className="container-fluid">
      ...
      <div className="container headerDiv ">
        <div className="row">
          ...
          >
            <h1 className="btechhead">WHAT IS KNIGHTDOGE PLATFORM</h1>
            <p className="paragraph">
              Knight Doge is the cryptocurrency of modern e-commerce platforms
              and potentially the greatest social network of all. Knight Doge is
              a Fly token built on Binance Smart Chain – BSC. The primary
              benefit of this staking hutt is that you earn more crypto, and
              interest rates can be very generous. IN KNIGHTDOGE staking policy
              there are 6 unlocking plans. In some plans, you can earn more than
              100% per month. It's potentially a very profitable way to invest
              your money. And, the only thing you need is crypto that uses the
        ...
        <div className="row">
          ...
          >
            ...
            <p className="paragraph">
              ...
              Staking software platform, KNIGHTDOGE Technology is the pioneer in
            ...
            <p className="paragraph">
              ...
              data-driven decisions, KNIGHTDOGE takes advantage of the benefits
